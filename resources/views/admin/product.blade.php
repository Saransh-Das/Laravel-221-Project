        ...
        <div class="container" align="center">
            ...
            <form action="{{url('uploadproduct')}}" method="post" enctype="multipart/form-data">
                ...
                <div style="padding:15px;">
                    ...
                    <input style="color:black;" type="text" name="des" placeholder="Give a Merch Description"
                        required="">
                </div>
                ...
                <div style="padding:15px;">
                    ...
                    <input style="color:black;" type="number" name="quantity" placeholder="Give a Merch Quantity"
                        required="">
                </div>
