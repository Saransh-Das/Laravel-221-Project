<div class="main-panel">
                    <div class="content-wrapper">
                                        ...
                                        <div class="row">
                                            <div class="col-9">
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        class="text-success ms-2 mb-0 font-weight-medium"
                                                    >
                                                        +3.5%
                                                    </p>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-9">
                                                ...
                                                >
                                                    <h3 class="mb-0">$12.34</h3>
                                                    <p
                                                        class="text-danger ms-2 mb-0 font-weight-medium"
                                                    >
                                                        -2.4%
                                                    </p>
                                                </div>
                            ...
                            <div class="col-md-4 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        >
                                            <div
                                                class="text-md-center text-xl-left"
                                            >
                                                <h6 class="mb-1">
                                                    Transfer to Paypal
                                                </h6>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="preview-list">
                                                    <div
                                                        class="preview-item border-bottom"
                                                    >
                                                        <div
                            ...
                            <div class="col-sm-4 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div
                                                class="col-8 col-sm-12 col-xl-8 my-auto"
                                            >
                                                <div
                        ...
                        <div class="row">
                            ...
                            >
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div
                                            class="progress progress-md portfolio-progress"
                                        >
                                            <div
                            ...
                            <div
                                class="col-md-12 col-xl-4 grid-margin stretch-card"
                            >
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="list-wrapper">
                                            ...
                                            >
                                                <li>
                                                    ...
                                                    <i
                                                        class="remove mdi mdi-close-box"
                                                    ></i>
                                                </li>
                                                <li>
                                                    <div
