    ...
    <div class="banner header-text">
        <div class="owl-banner owl-carousel">
            ...
            <div class="banner-item-02">
                <div class="text-content">
                    <h4>Flash Deals</h4>
                    <h2>Get your favorite Merchandise today</h2>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="left-content">
                        ...
                        <p>
                            ...
                            We are distributors of Saransh Mechandise.
                            You have no permission to redistribute
                            the downloadable Image file on any commercial
                            purpose.
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="inner-content">
                        <p>
                            Copyright &copy; 2022 My Merchandise Co.
                    </div>
                </div>
            </div>
        </div>
